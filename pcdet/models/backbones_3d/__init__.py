...
from .spconv_backbone import VoxelBackBone8x, VoxelResBackBone8x ,VoxelResBackBone8x_AD_SHC
...
from .spconv_backbone_voxelnext import VoxelResBackBone8xVoxelNeXt,VoxelResBackBone8xVoxelNeXt_WUXIACY,VoxelResBackBone8xVoxelNeXt_WUXISHU
...
__all__ = {
    ...
    'DSVT': DSVT,
    'VoxelResBackBone8x_AD_SHC':VoxelResBackBone8x_AD_SHC,
