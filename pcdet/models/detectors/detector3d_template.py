...
class Detector3DTemplate(nn.Module):
    ...
    def build_backbone_2d_p(self, model_info_dict):
        # print('llllllllllll',model_info_dict.get('num_bev_features', None))
        # print('llllllllllll',self.model_cfg.get('BACKBONE_2D_P', None))
        if self.model_cfg.get('BACKBONE_2D_P', None) is None:
            return None, model_info_dict
        # print('llllllllllll',self.model_cfg)

        backbone_2d_module_P = backbones_2d.__all__[self.model_cfg.BACKBONE_2D_P.NAME](
            model_cfg=self.model_cfg.BACKBONE_2D_P,
            input_channels=64
        )
        model_info_dict['module_list'].append(backbone_2d_module_P)
        model_info_dict['num_bev_features'] = backbone_2d_module_P.num_bev_features
        # print(model_info_dict['num_bev_features'])
        return backbone_2d_module_P, model_info_dict
    ...
    def build_backbone_2d(self, model_info_dict):
        ...
        if self.model_cfg.get('BACKBONE_2D', None) is None:
            return None, model_info_dict
        # print(model_info_dict.get('num_bev_features', None))
