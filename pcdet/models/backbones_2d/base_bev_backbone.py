...
class BaseBEVBackbone_P(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        if len(self.deblocks) > len(self.blocks):
            x = self.deblocks[-1](x)
        # print('spatial_features',x.shape)
...
class BaseBEVResBackbone(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        return data_dict
class BaseBEVResBackbone_P(nn.Module):
    def __init__(self, model_cfg, input_channels):
        super().__init__()
        self.model_cfg = model_cfg
    ...
    def forward(self, data_dict):
        ...
        # print('llllllllll',data_dict['spatial_features'].shape)

        return data_dict
class BaseBEVResBackbone_P_wushangcy(nn.Module):
    def __init__(self, model_cfg, input_channels):
        super().__init__()
        self.model_cfg = model_cfg
